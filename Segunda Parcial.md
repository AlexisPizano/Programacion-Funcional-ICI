...
### __1.Datos de Tipado Estático__
...
### __3.Interpolacion de Cadenas__
    void main() {
...
### __9.Casting de Datos Numéricos__
    void main() {
      num a = 4;
      ...
      print("el valor es $a");
      print(a+b); //Casting implicito, si un dato es entero y el otro resultado es flotante.
     print(a/b);
    }
    void main(List<String> args) {
      var a = "5";
...
### __11.Operaciones Aritméticas__
    main() {
      //division
      print((10 / 3).truncate());
      print(10 / 3);
...
### __12.Incrementos y Decrementos__
    //INCREMENTOS
    void main(List<String> args) {
...
### __14.Clases y Constructores con Get y Setter p1__
    void main() {
...
### __15.Clases y Constructores con Get y Setter p2__
    void main() {
...
### __16.Clases y Constructores con Get y Setter p3__
     void main() {
      User usuario = User.nombre("Kurt");
      User usuario2 = User.edad(15);
      print(usuario.getNombre);
...
### __17.Manejo de Constructores, Clases, Metodo Getter y Setter__
    void main() {
